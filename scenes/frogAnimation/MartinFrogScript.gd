...
@export var timerL = 1
@export var oldTargetL = Vector2()
@export var currentTargetL = Vector2()
@export var midTargetL = Vector2()

@export var timerR = 1
@export var oldTargetR = Vector2()
@export var currentTargetR = Vector2()
@export var midTargetR = Vector2()
